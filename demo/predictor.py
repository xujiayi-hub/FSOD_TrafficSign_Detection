...
class COCODemo(object):
    ...
    def run_on_opencv_image(self, image):
        ...
        boxes, scores, labels,result = self.overlay_class_names(result, top_predictions)

        return boxes, scores, labels,result
    ...
    def overlay_class_names(self, image, predictions):
        ...
        for box, score, label in zip(boxes, scores, labels):
            ...
            cv2.putText(
                image, s, (x, y), cv2.FONT_HERSHEY_SIMPLEX, .75, (255, 255, 255), 2
            )
