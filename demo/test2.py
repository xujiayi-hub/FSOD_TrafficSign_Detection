...
"font: 9pt \"Arial\";")
   ...
   def retranslateUi(self, MainWindow):
        ...
        #self.StartButton_7.setText(_translate("MainWindow", "选择模型"))
        self.StartButton_6.clicked.connect(self.newwinshow_1)
