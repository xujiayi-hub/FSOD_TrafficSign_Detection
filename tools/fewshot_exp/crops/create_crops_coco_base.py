...
# annofiles = ["datasets/coco/annotations/instances_train2014_base.json",
#              "datasets/coco/annotations/instances_valminusminival2014_base.json"]

# imgdirs = ['datasets/coco/train2017']
# annofiles = ["datasets/coco/annotations/instances_val2017_base.json"]
imgdirs = ['datasets/coco/train2017']
annofiles = ["datasets/coco/annotations/instances_train2017_base.json"]
